...
[Here](https://github.com/genicsblog/theme-files/blob/aa7944b1943dbb7206b013dcc1d8102f8c48875e/.github/workflows/setup-staging.yml) is the GitHub Actions file that deployed the theme to staging url. We made sure to block indexing using the robots.txt file:
...
This is the reason we use Vercel to off-load all these security issues and still be able to deploy staging ENVs!
